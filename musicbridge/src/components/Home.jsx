    ...
    <div>
            ...
            <label htmlFor="url" className="flex justify-between text-gray-700 font-bold mb-2">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="outline" className=" border shadow-xl w-32 mb-2 gap-5"><ArrowRightIcon className='w-4 h-3'/> {quality}</Button>
                </DropdownMenuTrigger>
                <DropdownMenuContent>
      ...
      {showAlert && (
        <div className="mt-6 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg flex items-center">
          ...
          <span>Download has completed. Check the Downloads.</span>
        </div>
      )}
